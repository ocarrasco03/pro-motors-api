...
use App\Support\Traits\Slug\HasTranslatableSlug;
use App\Support\Traits\Slug\SlugOptions;
use App\Support\Exceptions\InvalidOption;
...
trait HasSlug
{
    ...
    protected function generateSlugOnCreate(): void
    {
        ...
        if ($this->slugOptions->preventOverwrite && $this->{$this->slugOptions->slugField} !== null) {
            return;
        }
